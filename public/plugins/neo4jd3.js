          ...
          function Neo4jD3(_selector, _options) {
            ...
            function color() {
              return options.colors[
                (options.colors.length * Math.random()) << 0
              ];
            }
            ...
            function defaultDarkenColor() {
              return d3
                .rgb(options.colors[options.colors.length - 1])
                .darker(1);
            }
...
*/
            ...
            function updateRelationships(r) {
              ...
              relationshipOutline =
                relationshipEnter.outline.merge(relationshipOutline);

              relationshipOverlay = svg.selectAll(".relationship .overlay");
              relationshipOverlay =
                relationshipEnter.overlay.merge(relationshipOverlay);
